(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_065af4._.js", {
...
function EquipoPage() {
    ...
    const [numeroEquipo, setNumeroEquipo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    // Manejo del número de equipo al cargar la página
    useEffect({
        "EquipoPage.useEffect": ()=>{
            const ultimoNumero = localStorage.getItem("numeroEquipo") || 0; // Obtener el último número de equipo
            const nuevoNumero = parseInt(ultimoNumero) + 1; // Incrementar en 1
            setNumeroEquipo(nuevoNumero); // Actualizar el estado
            localStorage.setItem("numeroEquipo", nuevoNumero); // Guardar el nuevo número en localStorage
        }
    }["EquipoPage.useEffect"], []);
...
_s(EquipoPage, "o3aKc5k+FFb7D2YaoCJjvgD9EIM=");
_c = EquipoPage;
var _c;
...
//# sourceMappingURL=_065af4._.js.map